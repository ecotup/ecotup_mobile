...
{
    suspend fun getDetailTransaksi(idTransaksi : String) = repository.getDetailTransactionFinish(idTransaksi)

    suspend fun updateRating(idDriver : String, rating : Int) = repository.updateRating(idDriver, rating)
}